  ...
  return (
    <>
      ...
      <div className={`fixed inset-0 z-[60] transition-all duration-500 ease-in-out ${
        ...
        {/* Offcanvas Panel */}
        <div className={`absolute right-0 top-0 h-full w-80 max-w-[85vw] bg-white/95 backdrop-blur-xl border-l border-slate-200/50 shadow-2xl transform transition-transform duration-500 ease-in-out ${
