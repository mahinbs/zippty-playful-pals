...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0e0e68] border-t border-slate-800 text-slate-300">
          ...
          <div className="space-y-4">
            <Link to="/">
              <img
                ...
                className="h-16 w-auto transition-transform duration-300 hover:scale-150 bg-white p-3 rounded"
              />
            </Link>
          ...
          <div className="space-y-4 md:flex flex-col items-end">
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                <Link
                  to="/shop"
                  className="block text-slate-400 hover:text-blue-400 transition-all duration-300 hover:translate-x-1"
                >
                  Interactive Robots
                </Link>
