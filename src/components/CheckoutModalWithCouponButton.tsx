...
import { CheckCircle, X, Tag, Percent, DollarSign, Clock, AlertCircle, Gift } from 'lucide-react';
...
export const CheckoutModalWithCouponButton: React.FC<CheckoutModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
